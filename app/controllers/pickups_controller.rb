...
def pickup_params
    ...
    :donor_phone, :donor_city, :donor_state, :donor_zip, :donor_dwelling_type, :item_notes, :donor_notes, :number_of_items, :pickup_label_color)
end
...
def day_and_pickup_params
    ...
    :donor_phone, :donor_city, :donor_state, :donor_zip, :donor_dwelling_type, :item_notes, :donor_notes, :number_of_items, :day_id, :pickup_label_color)
end
